...
FINALLY_0122_1:
				{// begin finally (depth: 2)
					...
					}
					{
						...
						NullCheck(L_38);
						RuntimeObject* L_39 = L_38->___OutgoingMessageLock_10;
						V_3 = L_39;
						V_4 = (bool)0;
					}
					{
...
IL_015b_1:
			...
			{// begin try (depth: 2)
				...
				ArraySegment_1_t3DC888623B720A071D69279F1FCB95A109195093 L_47 = __this->___buffer_2;
				int32_t L_48 = __this->___messageType_4;
				...
				L_51 = VirtualFuncInvoker4< Task_t751C4CC3ECD055BABA8A0B6A5DFBB4283DCA8572*, ArraySegment_1_t3DC888623B720A071D69279F1FCB95A109195093, int32_t, bool, CancellationToken_t51142D9C6D7C02D314DA34A6A7988C528992FFED >::Invoke(11 /* System.Threading.Tasks.Task System.Net.WebSockets.WebSocket::SendAsync(System.ArraySegment`1<System.Byte>,System.Net.WebSockets.WebSocketMessageType,System.Boolean,System.Threading.CancellationToken) */, L_46, L_47, L_48, (bool)1, L_50);
				// t.Wait(m_CancellationToken);
				WebSocket_tA854BC697D5FA80EB48E9217EF622E0F9B0E325F* L_52 = V_1;
				NullCheck(L_52);
				CancellationToken_t51142D9C6D7C02D314DA34A6A7988C528992FFED L_53 = L_52->___m_CancellationToken_9;
				NullCheck(L_51);
